...
ZK_AUTH="`etcdctl -u $ROOT_USERNAME:$ROOT_PASSWORD get /zookeeper/config/username`:`etcdctl -u $ROOT_USERNAME:$ROOT_PASSWORD get /zookeeper/config/password`"
...
CTL_SIZE="`etcdctl -u $ROOT_USERNAME:$ROOT_PASSWORD get /zookeeper/config/ensemble-size`"
