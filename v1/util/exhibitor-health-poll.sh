...
ZK_AUTH="`etcdctl -u $ETCD_USER:$ETCD_PASSWORD get /zookeeper/config/username`:`etcdctl -u $ETCD_USER:$ETCD_PASSWORD get /zookeeper/config/password`"
...
CTL_SIZE="`etcdctl -u $ETCD_USER:$ETCD_PASSWORD get /zookeeper/config/ensemble-size`"
